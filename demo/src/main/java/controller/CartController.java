...
public class CartController {
	...
	public void addItem(@RequestParam String customerName ,@RequestParam(value = "productId") long productId, Model model) {
		Customer customer = new Customer();
		customer.setCustomerName(customerName);
		customerRepository.save(customer);
		
		Cart cart = new Cart();
		cart.setCustomer(customerRepository.findById(customer.getCustomerId()));
	...
	public String removeItem(@PathVariable Long productId) {
		cartItemRepository.delete(productId);
